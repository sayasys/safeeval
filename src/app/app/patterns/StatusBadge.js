// Status badge for a pattern. Presentational and server-safe (no client hooks)
// so it renders inside the list and detail server components.
//
// Spec: docs/memos/2026-05-29-custom-patterns-and-classifiers-scoping.md
// section 3.1 (the active | archived lifecycle).
